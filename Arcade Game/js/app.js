...
while (enemies< 3){
    var enemyspeed = Math.floor((Math.random() * 120) + 10) ;
    allEnemies.push(new Enemy(-2,60, enemyspeed));
     var enemyspeed = Math.floor((Math.random() * 150) +25);
    allEnemies.push(new Enemy(-2,140, enemyspeed));
     var enemyspeed = Math.floor((Math.random() * 130) + 10) ;
    allEnemies.push(new Enemy(-2,233, enemyspeed));
    enemies++;
};   
